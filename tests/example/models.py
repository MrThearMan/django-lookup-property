...
class Example(models.Model):
    ...
    @lookup_property
    def cast_uuid(self):
        return functions.Cast(models.Value("a2cabdde-bc6b-4626-87fe-dea41458dd8f"), output_field=models.UUIDField())
